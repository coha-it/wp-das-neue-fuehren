...
function seopress_schemas_maybe_render_blank_state( $which ) {
	...
	if ( $post_type === 'seopress_schemas' && 'bottom' === $which ) {
...
function seopress_schemas_cpt($post){
		...
		wp_enqueue_script( 'seopress-pro-rich-snippets-js', plugins_url('assets/js/seopress-pro-rich-snippets' . $prefix . '.js', dirname(dirname( __FILE__ ))), array('jquery'), SEOPRESS_PRO_VERSION, false );
		...
		function seopress_schemas_mapping_array($post_meta_name, $case) {
			...
			if (isset($seopress_schemas_cf) && $case !='custom') {
				$html .= $seopress_schemas_cf;
			}
			if (isset($seopress_schemas_tax) && $case !='custom') {
							...
							<div class="box-left">
								...
								<div class="wrap-rich-snippets-products">';
									...
									if ( is_plugin_active( 'woocommerce/woocommerce.php' )) {
										if ((get_option('woocommerce_enable_reviews') =='no' && get_option('woocommerce_enable_reviews'))
										|| (get_option('woocommerce_enable_review_rating') =='no' && get_option('woocommerce_enable_review_rating'))
										|| (get_option('woocommerce_review_rating_required') =='no' && get_option('woocommerce_review_rating_required'))) {
										...
										if (get_option('woocommerce_enable_review_rating') =='no' && get_option('woocommerce_enable_review_rating')) {
											echo '<br><span class="dashicons dashicons-minus"></span>'.__('Enable star rating on reviews','wp-seopress-pro');
										}
										if (get_option('woocommerce_review_rating_required') =='no' && get_option('woocommerce_review_rating_required')) {
