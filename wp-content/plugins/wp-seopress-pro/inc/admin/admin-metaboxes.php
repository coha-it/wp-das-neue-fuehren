...
function seopress_pro_admin_std_metaboxe_display() {
	...
	function seopress_pro_cpt($post){
		...
		$seopress_pro_rich_snippets_article_coverage_start_date         = get_post_meta($post->ID,'_seopress_pro_rich_snippets_article_coverage_start_date',true);
		$seopress_pro_rich_snippets_article_coverage_start_time         = get_post_meta($post->ID,'_seopress_pro_rich_snippets_article_coverage_start_time',true);
		$seopress_pro_rich_snippets_article_coverage_end_date           = get_post_meta($post->ID,'_seopress_pro_rich_snippets_article_coverage_end_date',true);
		$seopress_pro_rich_snippets_article_coverage_end_time           = get_post_meta($post->ID,'_seopress_pro_rich_snippets_article_coverage_end_time',true);
		...
		$seopress_pro_rich_snippets_lb_cuisine                          = get_post_meta($post->ID,'_seopress_pro_rich_snippets_lb_cuisine',true);
		...
		$seopress_pro_rich_snippets_events_previous_start_date          = get_post_meta($post->ID,'_seopress_pro_rich_snippets_events_previous_start_date',true);
		$seopress_pro_rich_snippets_events_previous_start_time          = get_post_meta($post->ID,'_seopress_pro_rich_snippets_events_previous_start_time',true);
		...
		$seopress_pro_rich_snippets_events_offers_valid_from_date       = get_post_meta($post->ID,'_seopress_pro_rich_snippets_events_offers_valid_from_date',true);
		$seopress_pro_rich_snippets_events_offers_valid_from_time       = get_post_meta($post->ID,'_seopress_pro_rich_snippets_events_offers_valid_from_time',true);
		...
		$seopress_pro_rich_snippets_events_status                       = get_post_meta($post->ID,'_seopress_pro_rich_snippets_events_status',true);
		$seopress_pro_rich_snippets_events_attendance_mode              = get_post_meta($post->ID,'_seopress_pro_rich_snippets_events_attendance_mode',true);
		...
		//Software app
		$seopress_pro_rich_snippets_softwareapp_name                    = get_post_meta($post->ID,'_seopress_pro_rich_snippets_softwareapp_name',true);
		$seopress_pro_rich_snippets_softwareapp_os                      = get_post_meta($post->ID,'_seopress_pro_rich_snippets_softwareapp_os',true);
		$seopress_pro_rich_snippets_softwareapp_cat                     = get_post_meta($post->ID,'_seopress_pro_rich_snippets_softwareapp_cat',true);
		$seopress_pro_rich_snippets_softwareapp_price                   = get_post_meta($post->ID,'_seopress_pro_rich_snippets_softwareapp_price',true);
		$seopress_pro_rich_snippets_softwareapp_currency                = get_post_meta($post->ID,'_seopress_pro_rich_snippets_softwareapp_currency',true);
		$seopress_pro_rich_snippets_softwareapp_rating                  = get_post_meta($post->ID,'_seopress_pro_rich_snippets_softwareapp_rating',true);
		...
		$tab1 = '<li><a href="#seopress-schemas-tabs-2">'. __( 'Automatic', 'wp-seopress' ) .'</a></li>';
		$tab2 = '<li><a href="#seopress-schemas-tabs-1">'. __( 'Manual', 'wp-seopress' ) .'</a></li>';
		$tabs = $tab1.$tab2;
	...
	'<div id="seopress-schemas-tabs">
		<ul class="wrap-schemas-list">
			...
			<li><a id="sp-automatic-tab" href="#seopress-schemas-tabs-2">'. __( 'Automatic', 'wp-seopress' ) .'<span></span></a></li>
		</ul>
			...
			<div class="box-left">
				...
				echo'
					...
					<p>
						...
						<span class="description">'.__('To use with Live Blog Posting article type','wp-seopress').'</span>
					...
					<p>
						...
						<span class="description">'.__('To use with Live Blog Posting article type','wp-seopress').'</span>
						<input type="text" name="seopress_pro_rich_snippets_article_coverage_start_time" placeholder="'.esc_html__('Eg: HH:MM','wp-seopress-pro').'" aria-label="'.__('Coverage Start Time','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_article_coverage_start_time.'" />
					</p>
					<p>
					...
					<p>
						...
						<span class="description">'.__('To use with Live Blog Posting article type','wp-seopress').'</span>
						<input type="text" name="seopress_pro_rich_snippets_article_coverage_end_time" placeholder="'.esc_html__('Eg: HH:MM','wp-seopress-pro').'" aria-label="'.__('Coverage End Time','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_article_coverage_end_time.'" />
					</p>
				</div>
...
For best results, provide multiple high-resolution images (minimum of 50K pixels when multiplying width and height) with the following aspect ratios: 16x9, 4x3, and 1x1.', 'wp-seopress-pro') .'</span>
					...
					<p>
						...
						<input type="text" name="seopress_pro_rich_snippets_lb_cuisine" placeholder="'.esc_html__('eg: French, Italian, Indian, American','wp-seopress-pro').'" aria-label="'.__('The type of cuisine the restaurant serves.','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_lb_cuisine.'" />
					</p>
					<p>
				...
				<div class="wrap-rich-snippets-videos">
					...
					<p>
						...
						<input type="text" name="seopress_pro_rich_snippets_videos_duration" placeholder="'.esc_html__('eg: 00:04:30 for 4 minutes and 30 seconds','wp-seopress-pro').'" aria-label="'.__('Duration of your video (format: hh:mm:ss)','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_videos_duration.'" />
				...
				<div class="wrap-rich-snippets-events">
					...
					<p>
						...
						<input type="text" name="seopress_pro_rich_snippets_events_previous_start_time" placeholder="'.esc_html__('Eg: HH:MM','wp-seopress-pro').'" aria-label="'.__('Previous start time','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_events_previous_start_time.'" />
					</p>
					<p>
					...
					<p>
						<label for="seopress_pro_rich_snippets_events_offers_valid_from_meta_date">'. __( 'Valid From', 'wp-seopress-pro' ) .'</label>
						...
						<input type="time" name="seopress_pro_rich_snippets_events_offers_valid_from_time" aria-label="'.__('The time when tickets go on sale','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_events_offers_valid_from_time.'" />
					</p>
					<p>
					...
					<p>
						...
						<select name="seopress_pro_rich_snippets_events_status">
					...
					<p>
						...
						<select name="seopress_pro_rich_snippets_events_attendance_mode">
				...
				<div class="wrap-rich-snippets-software-app">
					...
					<p>
						...
						<input type="text" name="seopress_pro_rich_snippets_softwareapp_name" placeholder="'.esc_html__('The name of your app','wp-seopress-pro').'" aria-label="'.__('App name','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_softwareapp_name.'" />
					</p>
					<p>
						<label for="seopress_pro_rich_snippets_softwareapp_os_meta">
							'. __( 'Operating system', 'wp-seopress-pro' ) .'</label>
						<input type="text" name="seopress_pro_rich_snippets_softwareapp_os" placeholder="'.esc_html__('The operating system(s) required to use the app','wp-seopress-pro').'" aria-label="'.__('Operating system','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_softwareapp_os.'" />
					</p>
					<p>
						<label for="seopress_pro_rich_snippets_softwareapp_cat_meta">'. __( 'Application category', 'wp-seopress-pro' ) .'</label>
						<select name="seopress_pro_rich_snippets_softwareapp_cat">
					...
					<p>
						...
						<input type="text" name="seopress_pro_rich_snippets_softwareapp_price" placeholder="'.esc_html__('The price of your app (set "0" if the app is free of charge)','wp-seopress-pro').'" aria-label="'.__('Price','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_softwareapp_price.'" />
					</p>
					<p>
						<label for="seopress_pro_rich_snippets_softwareapp_currency_meta">
							'. __( 'Currency', 'wp-seopress-pro' ) .'</label>
						<input type="text" name="seopress_pro_rich_snippets_softwareapp_currency" placeholder="'.esc_html__('Currency: USD, EUR...','wp-seopress-pro').'" aria-label="'.__('Currency','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_softwareapp_currency.'" />
					</p>
					<p>
						<label for="seopress_pro_rich_snippets_softwareapp_rating_meta">
							'. __( 'Your rating', 'wp-seopress-pro' ) .'</label>
						<input type="number" max="5" min="1" step="0.1" name="seopress_pro_rich_snippets_softwareapp_rating" placeholder="'.esc_html__('The item rating','wp-seopress-pro').'" aria-label="'.__('Your rating','wp-seopress-pro').'" value="'.$seopress_pro_rich_snippets_softwareapp_rating.'" />
					</p>
				</div>
