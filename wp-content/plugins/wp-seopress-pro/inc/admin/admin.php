...
class seopress_pro_options
{
	...
	public function page_init()
	{
		...
		add_settings_section(
			...
			'',
			//__("Analytics","wp-seopress"), // Title
	...
	public function print_pro_section($key) {
		...
		$sections = [
			...
			'page-speed'=> [
				'icon' => 'performance',
				'title' => __('Page Speed','wp-seopress-pro'),
				'desc' => __('Check your site performance with Google Page Speed (beta).', 'wp-seopress-pro')
			],
			'robots'=> [
				'toggle' => 1,
				'icon' => 'media-text',
	...
	public function print_section_info_page_speed() {
		...
		echo '<button type="button" class="seopress-request-page-speed button button-primary" data_permalink="'.get_home_url().'"><span class="dashicons dashicons-dashboard"></span>'.__('Analyse homepage with Page Speed','wp-seopress-pro').'</button> ';
	...
	public function print_section_info_google_analytics_ecommerce() {
		print_r( __('Track your ecommerce metrics with Google Enhanced Ecommerce.', 'wp-seopress') );
	...
	public function seopress_local_business_cuisine_callback()
	{
		...
		echo '<p class="description">'.__('Only to be filled if the business type is: "FoodEstablishment", "Bakery", "BarOrPub", "Brewery", "CafeOrCoffeeShop", "FastFoodRestaurant", "IceCreamShop", "Restaurant" or "Winery".','wp-seopress').'</p>';
	}
	...
	public function seopress_rich_snippets_publisher_logo_callback()
	{
		...
		echo '<ul class="seopress-list notice notice-info" style="margin: 0">
			<strong>'.__('Make sure your image follow these Google guidelines','wp-seopress').'</strong><br><br>
