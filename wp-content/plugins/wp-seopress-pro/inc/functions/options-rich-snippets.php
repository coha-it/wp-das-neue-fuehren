...
if (seopress_rich_snippets_enable_option() =='1') { //Is RS enable
	...
	function seopress_pro_rich_snippets_article_coverage_start_date_option() {
		$_seopress_pro_rich_snippets_article_coverage_start_date = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_article_coverage_start_date',true);
	...
	function seopress_pro_rich_snippets_article_coverage_start_time_option() {
		$_seopress_pro_rich_snippets_article_coverage_start_time = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_article_coverage_start_time',true);
	...
	function seopress_pro_rich_snippets_article_coverage_end_date_option() {
		$_seopress_pro_rich_snippets_article_coverage_end_date = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_article_coverage_end_date',true);
	...
	function seopress_pro_rich_snippets_article_coverage_end_time_option() {
		$_seopress_pro_rich_snippets_article_coverage_end_time = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_article_coverage_end_time',true);
	...
	function seopress_pro_rich_snippets_lb_cuisine_option() {
		$_seopress_pro_rich_snippets_lb_cuisine = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_lb_cuisine',true);
	...
	function seopress_rich_snippets_events_previous_start_date_option() {
		$_seopress_pro_rich_snippets_events_previous_start_date = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_events_previous_start_date',true);
	...
	function seopress_rich_snippets_events_previous_start_time_option() {
		$_seopress_pro_rich_snippets_events_previous_start_time = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_events_previous_start_time',true);
	...
	function seopress_rich_snippets_events_offers_valid_from_date_option() {
		$_seopress_pro_rich_snippets_events_offers_valid_from_date = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_events_offers_valid_from_date',true);
	...
	function seopress_rich_snippets_events_offers_valid_from_time_option() {
		$_seopress_pro_rich_snippets_events_offers_valid_from_time = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_events_offers_valid_from_time',true);
	...
	function seopress_rich_snippets_events_status_option() {
		$_seopress_pro_rich_snippets_events_status_option = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_events_status',true);
	...
	function seopress_rich_snippets_events_attendance_mode_option() {
		$_seopress_pro_rich_snippets_events_attendance_mode_option = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_events_attendance_mode',true);
	...
	function seopress_rich_snippets_softwareapp_name_option() {
		$_seopress_pro_rich_snippets_softwareapp_name = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_softwareapp_name',true);
	...
	function seopress_rich_snippets_softwareapp_os_option() {
		$_seopress_pro_rich_snippets_softwareapp_os = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_softwareapp_os',true);
	...
	function seopress_rich_snippets_softwareapp_cat_option() {
		$_seopress_pro_rich_snippets_softwareapp_cat = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_softwareapp_cat',true);
	...
	function seopress_rich_snippets_softwareapp_price_option() {
		$_seopress_pro_rich_snippets_softwareapp_price = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_softwareapp_price',true);
	...
	function seopress_rich_snippets_softwareapp_currency_option() {
		$_seopress_pro_rich_snippets_softwareapp_currency = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_softwareapp_currency',true);
	...
	function seopress_rich_snippets_softwareapp_rating_option() {
		$_seopress_pro_rich_snippets_softwareapp_rating = get_post_meta(get_the_ID(),'_seopress_pro_rich_snippets_softwareapp_rating',true);
