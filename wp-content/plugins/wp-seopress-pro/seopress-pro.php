...
//Define
///////////////////////////////////////////////////////////////////////////////////////////////////
define( 'SEOPRESS_PRO_VERSION', '3.8.9' ); 
...
function seopress_google_news_rewrite() {
	//Google News
	if (seopress_xml_sitemap_news_enable_option() =='1' && function_exists('seopress_get_toggle_option') && seopress_get_toggle_option('news') =='1') {
