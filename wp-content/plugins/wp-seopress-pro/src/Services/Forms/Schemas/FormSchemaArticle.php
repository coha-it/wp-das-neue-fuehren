...
class FormSchemaArticle extends FormApi {
    ...
    protected function getLabelByField($field) {
        switch ($field) {
            case '_seopress_pro_rich_snippets_article_type':
                return __('Select your article type', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_title':
                return __('Headline (max limit: 110)', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_author':
                return __('Post author', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_img':
                return __('Image', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_start_date':
                return __('Coverage Start Date', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_start_time':
                return __('Coverage Start Time', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_end_date':
                return __('Coverage End Date', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_end_time':
                return __('Coverage End Time', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_speakable_css_selector':
                return __('Speakable CSS Selector', 'wp-seopress');
        }
    }
    ...
    protected function getPlaceholderByField($field) {
        switch ($field) {
            case '_seopress_pro_rich_snippets_article_title':
                return __('The headline of the article', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_author':
                return __('The author of the article', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_img':
                return __('Select your image', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_start_date':
                return __('The beginning of live coverage. For example, "2017-01-24T19:33:17+00:00".', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_start_time':
            case '_seopress_pro_rich_snippets_article_coverage_end_time':
                return __('Eg: HH:MM', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_coverage_end_date':
                return __('The end of live coverage. For example, "2017-01-24T19:33:17+00:00".', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_speakable_css_selector':
                return __('Eg: post', 'wp-seopress');
            default:
                return '';
        }
    }
    ...
    protected function getDescriptionByField($field) {
        switch ($field) {
            case '_seopress_pro_rich_snippets_article_type':
                return '';
            case '_seopress_pro_rich_snippets_article_title':
                return __('Default value if empty: Post title', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_author':
                return __('Default value if empty: Post author', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_img':
                return __('The representative image of the article. Only a marked-up image that directly belongs to the article should be specified. Default value if empty: Post thumbnail (featured image). Minimum size: 696px wide, JPG, PNG or GIF, crawlable and indexable (default: post thumbnail if available)', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_img_width':
            case '_seopress_pro_rich_snippets_article_img_height':
                return '';
            case '_seopress_pro_rich_snippets_article_coverage_start_date':
            ...
            case '_seopress_pro_rich_snippets_article_coverage_end_date':
            case '_seopress_pro_rich_snippets_article_coverage_end_time':
                return __('To use with Live Blog Posting article type', 'wp-seopress');
            case '_seopress_pro_rich_snippets_article_speakable_css_selector':
                return __('Addresses content in the annotated pages (such as class attribute)', 'wp-seopress');
        }
    }
