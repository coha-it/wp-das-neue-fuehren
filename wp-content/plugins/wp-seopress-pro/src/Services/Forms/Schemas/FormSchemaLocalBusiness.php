...
class FormSchemaLocalBusiness extends FormApi {
    ...
    protected function getPlaceholderByField($field) {
        switch ($field) {
            ...
            case '_seopress_pro_rich_snippets_lb_state':
                return __('eg: Pyrenees Atlantiques', 'wp-seopress-pro');
            case '_seopress_pro_rich_snippets_lb_pc':
    ...
    protected function getDescriptionByField($field) {
        switch ($field) {
            ...
            case '_seopress_pro_rich_snippets_lb_opening_hours':
                return __("<strong>Morning and Afternoon are just time slots.</strong> Eg: if you're opened from 10:00 AM to 9:00 PM, check Morning and enter 10:00 / 9:00. If you are open non-stop, check Morning and enter 0:00 / 23:59.", 'wp-seopress-pro');
            default:
                return '';
        }
    }
