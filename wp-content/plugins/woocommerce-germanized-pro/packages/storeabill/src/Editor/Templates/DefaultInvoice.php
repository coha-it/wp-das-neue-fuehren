...
class DefaultInvoice extends Template {
	...
	public static function get_html() {
		...
		<p class="has-text-align-left" style="font-size:25px"><strong><?php echo apply_filters( self::get_hook_prefix() . 'document_title', strtoupper( _x( 'Invoice', 'storeabill-core', 'woocommerce-germanized-pro' ) ) ); ?></strong></p>
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				<p>
					...
					<?php echo esc_html_x( 'Order number', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>: <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Order number', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="document?data=order_number"><span class="editor-placeholder"></span><?php echo $preview->get_order_number(); ?></span><br>
					<?php echo esc_html_x( 'Payment method', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>: <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Payment method', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="document?data=payment_method_title"><span class="editor-placeholder"></span><?php echo $preview->get_payment_method_title(); ?></span><br>
        ...
        <p class="has-text-align-left"><?php echo apply_filters( self::get_hook_prefix() . 'reverse_charge_notice', esc_html_x( 'Tax liability of the recipient of the services.', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?></p>
        <!-- /wp:storeabill/reverse-charge-notice -->

        <!-- wp:storeabill/third-country-notice -->
        <p class="has-text-align-left"><?php echo apply_filters( self::get_hook_prefix() . 'third_country_notice', esc_html_x( 'Tax-exempt export delivery.', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?></p>
        <!-- /wp:storeabill/third-country-notice -->
